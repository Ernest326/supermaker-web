...
var _chunk67HTYUTXcjs = require('./chunk-67HTYUTX.cjs');

// src/util/fetch.ts
var _crossfetch = require('cross-fetch'); var ponyfill = _interopRequireWildcard(_crossfetch);
...
var api_exports = {};
_chunk67HTYUTXcjs.__export.call(void 0, api_exports, {
...
_chunk67HTYUTXcjs.__export.call(void 0, channels_exports, {
...
var ignite_exports = {};
_chunk67HTYUTXcjs.__export.call(void 0, ignite_exports, {
...
_chunk67HTYUTXcjs.__export.call(void 0, projects_exports, {
...
var APIClient = class {
  static getAuthType(auth) {
    const prefix = _chunk67HTYUTXcjs.getIdPrefix.call(void 0, auth);
  ...
  async parseResponse(request, response) {
    if (response.status === 204 || !_optionalChain([response, 'access', _2 => _2.headers, 'access', _3 => _3.get, 'call', _4 => _4("Content-Type"), 'optionalAccess', _5 => _5.includes, 'call', _6 => _6("application/json")])) {
      return void 0;
    }
  ...
  async request(method, path, body, query = {}, init = {}) {
    ...
    const headers = new Headers2({
      ..._nullishCoalesce(_optionalChain([init, 'optionalAccess', _7 => _7.headers]), () => ( {})),
...
var _jsonmethods = require('@onehop/json-methods');
...
var channels = sdk((client) => {
  const Channels = _jsonmethods.create.call(void 0, ).methods({
  ...
  const channelsSDK = {
    async create(type, id2, options, project) {
      ...
      const { channel } = id2 ? await client.put(
        ...
        { type, state: _nullishCoalesce(_optionalChain([options, 'optionalAccess', _8 => _8.state]), () => ( {})) },
        { project, channel_id: id2 }
      ) : await client.post(
        "/v1/channels",
        { type, state: _nullishCoalesce(_optionalChain([options, 'optionalAccess', _9 => _9.state]), () => ( {})) },
        { project }
      );
...
var ignite = sdk((client) => {
  const Gateways = _jsonmethods.create.call(void 0, ).methods({
  ...
  const Deployments = _jsonmethods.create.call(void 0, ).methods({
    getContainers() {
  ...
  async function getDeployment(projectIdOrId, name) {
    if (name) {
      _chunk67HTYUTXcjs.assertId.call(void 0, 
        projectIdOrId,
        "project",
...
var pipe = sdk((client) => {
  const Rooms = _jsonmethods.create.call(void 0, ).methods({
    async delete() {
      ...
      async create(name, options) {
        const { room } = await client.post(
          "/v1/pipe/rooms",
          {
            ...
            ephemeral: _nullishCoalesce(options.ephemeral, () => ( false)),
...
exports.API = api_exports; exports.APIClient = APIClient; exports.BROAD_PERMISSIONS_MAP = BROAD_PERMISSIONS_MAP; exports.ChannelType = ChannelType; exports.ContainerState = ContainerState; exports.DEFAULT_BASE_URL = DEFAULT_BASE_URL; exports.Hop = Hop; exports.HopAPIError = HopAPIError; exports.ID_PREFIXES = _chunk67HTYUTXcjs.ID_PREFIXES; exports.IS_BROWSER = IS_BROWSER; exports.PROJECT_PERMISSION = PROJECT_PERMISSION; exports.RuntimeType = RuntimeType; exports.asId = _chunk67HTYUTXcjs.asId; exports.assertId = _chunk67HTYUTXcjs.assertId; exports.getIdPrefix = _chunk67HTYUTXcjs.getIdPrefix; exports.id = _chunk67HTYUTXcjs.id; exports.isValidByteString = isValidByteString; exports.parseSize = parseSize; exports.permissions = permissions; exports.permissionsMap = permissionsMap; exports.roles = roles; exports.units = units; exports.validateAPIAuthentication = validateAPIAuthentication; exports.validateId = _chunk67HTYUTXcjs.validateId; exports.validateIdPrefix = _chunk67HTYUTXcjs.validateIdPrefix;
